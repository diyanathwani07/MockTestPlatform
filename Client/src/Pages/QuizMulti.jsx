...
import { Sun, Moon, Clock, Bookmark, ArrowLeft, ArrowRight, LayoutGrid, CheckCircle, Trash2, Info, X, FileText, Calendar } from "lucide-react";
          ...
          <div className="submitted-details-row">
            <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
              ...
              <div>
                ...
                <p style={{ margin: "2px 0 0", fontSize: "13px", fontWeight: "600", color: "var(--text-primary)", lineHeight: "1.4" }}>{quizTitle}</p>
              </div>
            </div>
