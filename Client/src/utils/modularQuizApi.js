...
export const saveModularQuiz = async ({
  ...
  const payload = {
    ...
    showResultAfterSubmission: quizMeta.showResultAfterSubmission !== undefined ? quizMeta.showResultAfterSubmission : true,
    showCorrectAnswers: quizMeta.showCorrectAnswers !== undefined ? quizMeta.showCorrectAnswers : true,
    showExplanations: quizMeta.showExplanations !== undefined ? quizMeta.showExplanations : true,
    showAnswerReview: quizMeta.showAnswerReview !== undefined ? quizMeta.showAnswerReview : true,
    resultReleaseMode: quizMeta.resultReleaseMode || "immediate",
    resultReleaseDate: quizMeta.resultReleaseDate || null,
    practiceShowResultAfterSubmission: quizMeta.practiceShowResultAfterSubmission !== undefined ? quizMeta.practiceShowResultAfterSubmission : true,
    practiceShowCorrectAnswers: quizMeta.practiceShowCorrectAnswers !== undefined ? quizMeta.practiceShowCorrectAnswers : true,
    practiceShowExplanations: quizMeta.practiceShowExplanations !== undefined ? quizMeta.practiceShowExplanations : true,
    practiceShowAnswerReview: quizMeta.practiceShowAnswerReview !== undefined ? quizMeta.practiceShowAnswerReview : true,
    practiceResultReleaseMode: quizMeta.practiceResultReleaseMode || "immediate",
    practiceResultReleaseDate: quizMeta.practiceResultReleaseDate || null,
...
export const saveModularPractice = async ({
  ...
  const payload = {
    ...
    published: isPublishing,
    status: isPublishing ? "Published" : quizMeta.status || "Draft",
    showResultAfterSubmission: quizMeta.practiceShowResultAfterSubmission !== undefined ? quizMeta.practiceShowResultAfterSubmission : true,
    showCorrectAnswers: quizMeta.practiceShowCorrectAnswers !== undefined ? quizMeta.practiceShowCorrectAnswers : true,
    showExplanations: quizMeta.practiceShowExplanations !== undefined ? quizMeta.practiceShowExplanations : true,
    showAnswerReview: quizMeta.practiceShowAnswerReview !== undefined ? quizMeta.practiceShowAnswerReview : true,
    practiceResultReleaseMode: quizMeta.practiceResultReleaseMode || "immediate",
    practiceResultReleaseDate: quizMeta.practiceResultReleaseDate || null,
    sections: sectionRefs,
    questions: [],
