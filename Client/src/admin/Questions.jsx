      ...
      <div className="admin-main">
        ...
        <div className="admin-content" style={{ padding: "24px", minHeight: 0 }}>
          <div className="qb-middle-header">
            {/* MIDDLE: Text (Always on top) */}
            <div className="qb-middle-center">
              <h2>Select a Quiz</h2>
              <p>Choose a quiz to view its subjects and questions.</p>
            </div>

            {/* TOGGLES CONTAINER - Always inline below the text */}
            <div className="qb-middle-toggles" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%", marginTop: "12px", gap: "8px" }}>
              {/* LEFT: Exams / Practice Toggle */}
              <div className="qb-middle-left" style={{ display: "flex", justifyContent: "flex-start", flex: "1" }}>
              ...
              <div className="qb-middle-right" style={{ display: "flex", justifyContent: "flex-end", flex: "1" }}>
