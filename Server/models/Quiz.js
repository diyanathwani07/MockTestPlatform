...
const quizSchema = new mongoose.Schema(
  {
    ...
    needsConfiguration: { type: Boolean, default: false },
    scheduledDate: { type: Date, default: null },
    published: { type: Boolean, default: false },
    isDeleted: { type: Boolean, default: false },
    deletedAt: { type: Date, default: null },
    quizType: { type: String, enum: ["exam", "practice", "custom"], default: "exam" },
    publishAs: { type: String, enum: ["exam", "practice", "both"], default: "exam" },
    passPercentage: { type: Number, default: 50 },
    markingPattern: { type: String, enum: ["standard", "bpsc"], default: "standard" },
    ...
    showPassFailStatus: { type: Boolean, default: true },
    showCorrectAnswers: { type: Boolean, default: true },
    showExplanations: { type: Boolean, default: true },
    showAnswerReview: { type: Boolean, default: true },
    practiceShowResultAfterSubmission: { type: Boolean, default: true },
    practiceShowCorrectAnswers: { type: Boolean, default: true },
    practiceShowExplanations: { type: Boolean, default: true },
    practiceShowAnswerReview: { type: Boolean, default: true },
    resultReleaseMode: { type: String, enum: ["immediate", "scheduled", "manual"], default: "immediate" },
    resultReleaseDate: { type: Date, default: null },
    ...
    examStructureId: { type: mongoose.Schema.Types.ObjectId, ref: "ExamStructure", default: null },
