...
const createQuiz = async (data) => {
  ...
  return Quiz.create({
    ...
    contentType: data.contentType || "interactive",
    ...
    plans: data.plans || [],
    markingPattern: data.markingPattern || "standard",
    aiSourceType: data.aiSourceType || "",
    aiSourcePrompt: data.aiSourcePrompt || "",
    aiSourceUrl: data.aiSourceUrl || "",
...
const syncToPracticeQuiz = async (quizId, publishAs) => {
  ...
  const practiceData = {
    ...
    examSeriesId: populatedQuiz.examSeriesId,
    examStructureId: populatedQuiz.examStructureId,
    pyqYear: populatedQuiz.pyqYear,
    testType: populatedQuiz.testType,
    shift: populatedQuiz.shift,
    topicName: populatedQuiz.topicName,
    testFormat: populatedQuiz.testFormat,
    contentType: populatedQuiz.contentType,
    pdfUrl: populatedQuiz.pdfUrl,
    pdfFileName: populatedQuiz.pdfFileName,
    allowDownload: populatedQuiz.allowDownload,
  };
